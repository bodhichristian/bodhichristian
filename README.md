...
* [Stubs](https://github.com/bodhichristian/Stubs) allows users to create a collection of concert tickets. Users create custom Stubs and the app provides a rich experience from the details.
